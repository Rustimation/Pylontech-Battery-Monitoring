/* Original software by Ireneusz Zielinski https://github.com/irekzielinski/Pylontech-Battery-Monitoring
Includes further enhancement to display battery status (Voltage, SoC, Status) on a SSD1306 display.
ATTENTION: This sketch reflects the NEW layout of the Pylontech pwr table valid for batteries with 
Firmware release date 24-05-13 or later. For further information see 
https://www.rustimation.eu/index.php/solar-pylontech-akku-ueber-konsole-aufwecken/ or
https://github.com/irekzielinski/Pylontech-Battery-Monitoring/issues/31
*/
...
void handleRoot() {
  ...
  snprintf(szTmp, sizeof(szTmp)-1, "<html><b>4.8kWh Pylontech US5000</b><br>Time CET: %d/%02d/%02d %02d:%02d:%02d (%s)<br>Uptime: %02d:%02d:%02d.%02d<br><br>free heap: %u<br>Wifi RSSI: %d<BR>Wifi SSID: %s", 
